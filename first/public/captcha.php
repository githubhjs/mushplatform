...
class CaptchaSecurityImages {
   ...
   function generateCode($characters) {
      ...
      $possible = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWYZ';
      $code = '';
      $i = 0;
      while ($i < $characters) { 
   ...
   function captcha($width='120',$height='40',$characters='6', $code) {
...
$captcha->captcha($width,$height,$characters,$code);
?>
