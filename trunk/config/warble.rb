...
Warbler::Config.new do |config|
  ...
  config.dirs = %w( app config doc log plugins tmp db lib sidebars themes vendor )
  #%w(app config lib log vendor tmp )
  ...
  config.gems += ["activerecord-jdbc-adapter", "hoe", "rubyforge", "paginator", "cached_model", "memcache-client", "ZenTest" ]
  # config.gems << "tzinfo"
